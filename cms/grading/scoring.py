...
def task_score(
    ...
    rounded: bool = False,
    submission: ScoredSubmission | None = None,
) -> tuple[float, bool]:
    ...
    submission: Optional object to save the scored submission.
...
def _task_score_max_tokened_last(
    score_details_tokened: list[tuple[float | None, object | None, bool, Submission]],
    *,
    submission: ScoredSubmission | None = None
) -> float:
    ...
    score_details_tokened: a tuple for each
    ...
    submission: An optional object to store scored submission.
