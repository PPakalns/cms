...
def default_argument_parser_init(
    description: str, ask_contest: Callable[[], int] | None = None
...
def default_argument_parser(
    description: str,
    cls: type[_ServiceT],
    ask_contest: Callable[[], int] | None = None,
    ...
    ask_contest: None if the service does not require
        a contest, otherwise a function that returns a contest_id
        (after asking the admins?)
    custom_argument_parser: None if the service does not require
        a contest, otherwise a function that returns a contest_id
        (after asking the admins?)
